function [Mz_mtx, Mxy_mtx, Mxy_mgre0] = sim_mwf_MIMOSA_bp_mxy0_cx_v2_dlarray(TR, alpha_deg, esp, turbo_factor, t1_vals, t2_vals, num_reps, echo2use, TR_mte,esp_mte,TEs, t2s_vals, gap_between_readouts, time2relax_at_the_end, b1, inv_eff,local_field_sim_Hz,pd_map )
%
...
for reps = 1:num_reps
    ...
    for q = 1:tf
        ...
        Mxy(q,:) = relax_T2s_phase_evo(sin(alpha) .* Mz,TE_flash,t2s_vals,local_field_sim_Hz);
        Mz = cos(alpha) .* Mz;
        time = esp;
    end
