...
def get_parser():
    ...
    parser.add_argument('--data_opt', type=str, default='_MWF_MIMOSA_R8_lam0p5_echoloss',
    ...
    parser.add_argument('--necho_GLOB', type=int, default=14,
    ...
    parser.add_argument('--batchSize', type=int, default=1,
                        help='batch size')
    parser.add_argument('--nb_unroll_blocks', type=int, default=4,
                        help='number of unrolled blocks')
    parser.add_argument('--nb_res_blocks', type=int, default=4,
                        help="number of residual blocks in ResNet")
    parser.add_argument('--CG_Iter', type=int, default=4,
    ...
    parser.add_argument('--TL_path', type=str, default='/pretrained_models/ZS_SSL_20260224_mwf_mimosa_R8_v2_lam0p5_echoloss_Rate1_2reps_unroll4res4CG4_mGPU/',
