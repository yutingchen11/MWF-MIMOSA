...
def get_parser():
    ...
    parser.add_argument('--data_opt', type=str, default='_MWF_MIMOSA_R8_700um_data2_lam0p5_echoloss',
                    help='type of dataset')
    parser.add_argument('--data_dir', type=str, default='/data',
                    help='data directory')                
    parser.add_argument('--nrow_GLOB', type=int, default=320,
                        help='number of rows of the slices in the dataset')
    parser.add_argument('--ncol_GLOB', type=int, default=274,
    ...
    parser.add_argument('--necho_GLOB', type=int, default=13,
    ...
    parser.add_argument('--batchSize', type=int, default=1,
                        help='batch size')
    parser.add_argument('--nb_unroll_blocks', type=int, default=3,
                        help='number of unrolled blocks')
    parser.add_argument('--nb_res_blocks', type=int, default=3,
                        help="number of residual blocks in ResNet")
    parser.add_argument('--CG_Iter', type=int, default=3,
    ...
    parser.add_argument('--TL_path', type=str, default='/pretrained_models/ZS_SSL_20260305_mwf_mimosa_s1_R8_700um_lam0p5_echoloss_Rate1_2reps_unroll3res3CG3_mGPU/',
