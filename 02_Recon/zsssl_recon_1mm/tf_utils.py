...
def test_graph(directory):
    ...
    trn_maskP = tf.compat.v1.placeholder(tf.complex64, shape=(None, args.nrow_GLOB, args.ncol_GLOB, args.necho_GLOB), name='trn_mask')
    loss_maskP = tf.compat.v1.placeholder(tf.complex64, shape=(None, args.nrow_GLOB, args.ncol_GLOB, args.necho_GLOB), name='loss_mask')
