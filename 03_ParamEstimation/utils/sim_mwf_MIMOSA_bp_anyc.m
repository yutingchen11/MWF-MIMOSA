function [Mz_mtx, Mxy_mtx] = sim_mwf_MIMOSA_bp_anyc(TR, alpha_deg, esp, turbo_factor, t1_vals, t2_vals, num_reps, echo2use, TR_mte,esp_mte,TEs, t2s_vals, gap_between_readouts, time2relax_at_the_end, b1, inv_eff,pd_map )
%
...
num_contrast = 4+length(TEs);

Mz_mtx = zeros([14, num_voxels, num_reps]);
Mxy_mtx = zeros([num_contrast, num_voxels, num_reps]);
...
%     M5 = -M4 .* inv_eff;
    ...
    Mxyecho = zeros(tf,num_voxels,length(TEs));
    time = 0;
