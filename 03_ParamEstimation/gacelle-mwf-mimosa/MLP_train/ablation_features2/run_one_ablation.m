...
% Usage examples:
% Usage examples:
%   run_one_ablation('freqA__none')
%   run_one_ablation('freqA__prepOH')
%   run_one_ablation('freqA__PT')
%   run_one_ablation('freqA__PT+prepOH')
%   run_one_ablation(1)
%% ---------------- Input parsing ----------------
...
root_prefix = 'MIMOSA_featAbl_freqA_timeOnly_v1';
