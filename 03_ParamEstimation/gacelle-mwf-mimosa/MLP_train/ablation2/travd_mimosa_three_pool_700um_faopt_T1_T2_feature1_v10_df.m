...
%% ===================== Output settings =====================
root_prefix = 'MIMOSA_featAbl_loss1_tau0p01_700um_opt_v1';
...
%%
%%
load('/autofs/cluster/berkin/yuting/MATLAB/QALAS_sim_brain/mwf_mimosa/phantom_sf/mwf_mimosa_10echoes_nogap_same_fa_noTEgap.mat');
output_epoch_1000 = double(output_epoch_1000);
alpha = round((output_epoch_1000)*1e5)./1e5;

%% ===================== Sequence parameters =====================
seq_param.esp             = 5.8e-3;
seq_param.turbo_factor    = 119;
seq_param.TR              = 4500e-3 - 5.8*119e-3 + 29.4*119e-3 - (900e-3 -seq_param.esp*seq_param.turbo_factor-1e-3)*2;
seq_param.alpha_deg       = alpha/pi*180;
seq_param.num_reps        = 5;
seq_param.echo2use        = 1;
seq_param.gap_between_readouts  = 900e-3;
seq_param.time2relax_at_the_end = 0;
seq_param.ncontrast       = 13;

seq_param.TEs     = [2.38:3:26.5].*1e-3;
seq_param.TR_mte  = 29.4e-3;
seq_param.esp_mte = 3e-3;
...
[~, Mxy_mtx_mw, ~] = sim_mwf_MIMOSA_bp_opt_mxy0_cx_v2_dlarray( ...
...
[~, Mxy_mtx_iew, ~] = sim_mwf_MIMOSA_bp_opt_mxy0_cx_v2_dlarray( ...
    seq.TR, seq.alpha_deg, seq.esp, seq.turbo_factor, ...
...
[~, Mxy_mtx_fw, ~] = sim_mwf_MIMOSA_bp_opt_mxy0_cx_v2_dlarray( ...
    seq.TR, seq.alpha_deg, seq.esp, seq.turbo_factor, ...
