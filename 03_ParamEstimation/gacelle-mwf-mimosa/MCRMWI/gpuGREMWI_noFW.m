classdef gpuGREMWI_noFW < handle
% Kwok-Shing Chan @ MGH
...
% Date modified: 22 September 2024
    ...
    properties
        ...
        lb              = [ 1e-8;    1e-8;   1e-8;       40;      6;      6;    -0.05;    -0.1;      -0.4;  -pi/2];
        startPoint      = [    1;     0.1;    0.6;      100;     16;     21;     0.04;       0;         0;      0];
    ...
    methods
        ...
        % constructuor
        function this = gpuGREMWI_noFW(te,fixed_params)
