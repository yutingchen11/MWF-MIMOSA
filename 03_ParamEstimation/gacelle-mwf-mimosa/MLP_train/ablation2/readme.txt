ablation2: abaltion of tempotral features

run_one_ablation Executable
...
================================
-run_one_ablation 
-run_run_one_ablation.sh (shell script for temporarily setting environment variables and 
                          executing the application)
   -to run the shell script, type
   
       ./run_run_one_ablation.sh <mcr_directory> <argument_list>
    ...
    /mathworks/home/application/R2024b, run the shell script as:
       ...
       ./run_run_one_ablation.sh /mathworks/home/application/R2024b
       
    If you have MATLAB installed in /mathworks/devel/application/matlab, 
    run the shell script as:
    
       ./run_run_one_ablation.sh /mathworks/devel/application/matlab
-MCRInstaller.zip
...
${LD_LIBRARY_PATH}:MR/R2024b/runtime/glnxa64:MR/R2024b/bin/glnxa64:MR/R2024b/sys/os/glnxa64:MR/R2024b/sys/opengl/lib/glnxa64
   ...
   Distribute in the MATLAB Compiler documentation in the MathWorks Documentation Center.
        ...
        NOTE: When deploying standalone applications, you can
              run the shell script file run_run_one_ablation.sh 
